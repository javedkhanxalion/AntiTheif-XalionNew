...
import com.antitheftalarm.dont.touch.phone.finder.databinding.MenuItemLinearLayoutBinding
            ...
            adsManager.nativeAds().loadNativeAd(
                ...
                object : NativeListener {
                    override fun nativeAdLoaded(currentNativeAd: NativeAd?) {
                        ...
                        val adView = if(val_ad_native_main_menu_screen_is_H){
                            context.layoutInflater.inflate(R.layout.ad_unified_media_high, null) as NativeAdView
                        }else{
                            context.layoutInflater.inflate(R.layout.ad_unified_media_high, null) as NativeAdView
                        }
